    ...
    <div className={styles.header}>
      ...
      <div className={styles.links}>
        <Link className={styles.link} href="/">Главная</Link>
				<Link className={styles.link} href="/calculator">Калькулятор</Link>
				<Link className={styles.link} href="/password-generator">Генератор паролей</Link>
      </div>
      <div className={styles.user}>
				<span className={styles.username}>артур</span>
